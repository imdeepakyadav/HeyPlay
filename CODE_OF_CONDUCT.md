...
- **Being Open-minded**: Welcoming newcomers and helping them get started
...
- **Intimidation**: Threatening behavior or language towards other community members
...
- **Social Media**: Official HeyPlay accounts and mentions
- **Events**: Conferences, meetups, and online events
- **Email Communications**: Official project communications
- **Other Platforms**: Any platform where you represent the HeyPlay community
...
2. **Participants**: Who was involved (if safe to share)
3. **Context**: Where the incident occurred
4. **Evidence**: Screenshots, links, or other documentation
5. **Impact**: How the incident affected you or others
6. **Desired Outcome**: What resolution you would like to see

### Reporting Process

1. **Immediate Safety**: If you feel unsafe, please contact local authorities first
2. **Initial Report**: Send a detailed report to the contacts above
3. **Acknowledgment**: We will acknowledge receipt within 24 hours
4. **Investigation**: We will investigate the matter thoroughly
5. **Resolution**: We will take appropriate action and communicate the outcome
6. **Follow-up**: We will check in to ensure the issue is resolved
...
- Temporary ban from GitHub repository
- Temporary ban from Discord server
- Suspension from community events
...
- Removal of all contributions (at discretion)
- Public announcement of ban (if necessary)
- Legal action (if applicable)

## Appeals Process

If you believe you have been unfairly sanctioned, you may appeal the decision:

1. **Submit Appeal**: Send an email to appeals@heyplay.app within 30 days
2. **Provide Information**: Include details about why you believe the decision was unfair
3. **Review Process**: A different team member will review your case
4. **Decision**: You will receive a response within 14 days
5. **Final Appeal**: If unsatisfied, you may request a final review by the project maintainer

## Community Resources

### Getting Help

- **Documentation**: Check our [contributing guide](CONTRIBUTING.md) for questions about development
- **Discord**: Join our community Discord for real-time help
- **GitHub Discussions**: Use GitHub Discussions for community questions
- **Stack Overflow**: Tag questions with `heyplay` for technical help

### Positive Community Examples

We encourage:

- **Welcoming newcomers** with helpful onboarding
- **Mentoring** less experienced contributors
- **Celebrating achievements** of community members
- **Sharing knowledge** through tutorials and examples
- **Providing constructive feedback** on contributions
- **Collaborating respectfully** on challenging problems
...
This Code of Conduct may be updated from time to time. All community members will be notified of significant changes. The current version will always be available in this repository.
...
Thank you for helping make HeyPlay a welcoming and inclusive community for everyone! 🎵
